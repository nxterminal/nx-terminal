...
const WINDOW_DEFAULTS = {
  ...
  'monad-city': { title: 'Mega City', icon: '', width: 1000, height: 700, x: 40, y: 20 },
  ...
  'mission-control': { title: 'Mission Control', icon: '\u{1F4CB}', width: 900, height: 700, x: 80, y: 20 },
  'achievements': { title: 'Achievements', icon: '\u2605', width: 800, height: 600, x: 100, y: 40 },
};
