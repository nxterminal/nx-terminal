...
const WINDOW_DEFAULTS = {
  ...
  'my-devs': { title: 'My Devs', icon: '\u{1F4CB}', width: 700, height: 480, x: 120, y: 55 },
  ...
  'notepad': { title: 'Notepad', icon: '\u{1F4DD}', width: 500, height: 420, x: 160, y: 65 },
  'recycle-bin': { title: 'Recycle Bin', icon: '\u{1F5D1}', width: 560, height: 400, x: 170, y: 70 },
};
