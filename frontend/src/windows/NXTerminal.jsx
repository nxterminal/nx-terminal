...
function SystemInfo() {
  return (
    <div className="terminal" style={{ height: '100%', overflow: 'auto', padding: '12px' }}>
      ...
      <div style={{ color: '#808080', marginTop: '12px', fontSize: 'var(--text-sm)' }}>NX Terminal Corp. (C) 1998. All rights reserved.</div>
    </div>
  );
}
...
function Handbook() {
  return (
    <div className="terminal" style={{ height: '100%', overflow: 'auto', padding: '12px', lineHeight: '1.6' }}>
      <div style={{ color: 'var(--terminal-amber)', fontSize: 'var(--text-xl)', fontWeight: 'bold', marginBottom: '12px', textAlign: 'center' }}>
      ...
      <div style={{ color: 'var(--terminal-amber)', fontSize: 'var(--text-lg)', fontWeight: 'bold', marginBottom: '8px' }}>{'> The Timeline'}</div>
      <div style={{ color: 'var(--terminal-green)', marginBottom: '16px' }}>
      ...
      <div style={{ color: 'var(--terminal-amber)', fontSize: 'var(--text-lg)', fontWeight: 'bold', marginBottom: '8px' }}>{'> The Corporations'}</div>
      ...
      <div style={{ color: 'var(--terminal-amber)', fontSize: 'var(--text-lg)', fontWeight: 'bold', marginBottom: '8px' }}>{'> The Singularity'}</div>
      <div style={{ color: 'var(--terminal-green)', marginBottom: '16px' }}>
      ...
      <div style={{ color: '#808080', textAlign: 'center', marginTop: '16px', fontSize: 'var(--text-sm)' }}>{'// END OF DECLASSIFIED DOCUMENT //'}</div>
    </div>
  );
}
...
function Lore() {
  return (
    <div className="terminal" style={{ height: '100%', overflow: 'auto', padding: '12px', lineHeight: '1.6' }}>
      ...
      <div style={{ color: 'var(--terminal-red)', fontWeight: 'bold', marginBottom: '4px', fontSize: 'var(--text-xs)', textAlign: 'center', letterSpacing: '2px' }}>
      ...
      <div style={{ borderTop: '1px solid var(--terminal-amber)', borderBottom: '1px solid var(--terminal-amber)', padding: '8px 0', margin: '8px 0 16px 0' }}>
        <div style={{ color: '#808080', fontSize: 'var(--text-sm)', textAlign: 'center', fontStyle: 'italic' }}>
          "Every line of code is a weapon. Every developer is a soldier. Every corporation is a lie."
        </div>
      </div>

      <div style={{ color: 'var(--terminal-amber)', fontSize: 'var(--text-lg)', fontWeight: 'bold', marginBottom: '8px' }}>{'> CHAPTER I: THE FOUNDING (1995)'}</div>
      <div style={{ color: 'var(--terminal-green)', marginBottom: '16px' }}>
      ...
      <div style={{ color: 'var(--terminal-amber)', fontSize: 'var(--text-lg)', fontWeight: 'bold', marginBottom: '8px' }}>{'> CHAPTER II: THE PROTOCOL WARS BEGIN (2005)'}</div>
      <div style={{ color: 'var(--terminal-green)', marginBottom: '16px' }}>
      ...
      <div style={{ color: 'var(--terminal-amber)', fontSize: 'var(--text-lg)', fontWeight: 'bold', marginBottom: '8px' }}>{'> CHAPTER III: THE DEVELOPER UPRISING (2012)'}</div>
      <div style={{ color: 'var(--terminal-green)', marginBottom: '16px' }}>
      ...
      <div style={{ color: 'var(--terminal-amber)', fontSize: 'var(--text-lg)', fontWeight: 'bold', marginBottom: '8px' }}>{'> CHAPTER IV: THE GREAT TOKEN CRASH (2018)'}</div>
      <div style={{ color: 'var(--terminal-green)', marginBottom: '16px' }}>
      ...
      <div style={{ color: 'var(--terminal-amber)', fontSize: 'var(--text-lg)', fontWeight: 'bold', marginBottom: '8px' }}>{'> CHAPTER V: THE SINGULARITY QUESTION (2023-PRESENT)'}</div>
      <div style={{ color: 'var(--terminal-green)', marginBottom: '16px' }}>
      ...
      <div style={{ borderTop: '1px solid var(--terminal-amber)', padding: '12px 0', marginTop: '8px' }}>
        <div style={{ color: 'var(--terminal-red)', fontSize: 'var(--text-sm)', textAlign: 'center' }}>
          {'[DOCUMENT CLASSIFICATION: OMEGA-7]'}
        </div>
        <div style={{ color: '#808080', fontSize: 'var(--text-xs)', textAlign: 'center', marginTop: '4px' }}>
...
function Links() {
  ...
  const linkText = { color: 'var(--terminal-cyan)', textDecoration: 'underline', fontSize: 'var(--text-base)' };
  const labelStyle = { color: 'var(--terminal-green)', fontSize: 'var(--text-base)', minWidth: '70px' };
  ...
  return (
    <div className="terminal" style={{ height: '100%', overflow: 'auto', padding: '12px' }}>
      ...
      <div style={{ color: '#808080', marginTop: '16px', fontSize: 'var(--text-sm)', textAlign: 'center' }}>
...
function Contracts() {
  ...
  const addr = { color: 'var(--terminal-cyan)', fontSize: 'var(--text-sm)', wordBreak: 'break-all' };
