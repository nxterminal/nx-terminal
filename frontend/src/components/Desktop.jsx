...
export default function Desktop() {
  ...
  // NX Market stays admin-gated pre-launch. The program entry itself
  // is hidden for non-admin wallets; the internal admin features
  // (Create Official, Resolve) remain independently gated inside
  // MarketsList / MarketDetailModal.
