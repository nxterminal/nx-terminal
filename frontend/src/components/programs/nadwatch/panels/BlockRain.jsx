...
export default function BlockRain({ blockNumber }) {
  ...
  useEffect(() => {
    ...
    const draw = (timestamp) => {
      ...
      // "MEGAETH FEED — LIVE" label
      ctx.save();
      ctx.font = '9px "Courier New", monospace';
      ctx.fillStyle = 'rgba(123, 47, 190, 0.7)';
      ctx.textAlign = 'left';
      ctx.fillText('MEGAETH FEED \u2014 LIVE', 6, 14);
      ctx.restore();
    };
  ...
  return (
    <div style={{ position: 'relative', width: '100%', height: '100%', background: '#000', overflow: 'hidden' }}>
      ...
      />
      <Tooltip
        text="Block Rain — Real-time visualization of MegaETH blockchain activity. Purple/green bicolor columns with Monanimal easter eggs."
