...
const TAB_CONTENT = {
  'About': [
    ...
    { type: 'text', text: '' },
    { type: 'text', text: 'MEGA_SDK is an interactive training program that teaches blockchain development through gamified coding exercises.' },
    { type: 'text', text: '' },
  ...
  'Beta Info': [
    ...
    { type: 'text', text: '  Write contracts from scratch, AMM liquidity provision, lending protocol interaction, security & vulnerability hunting, MegaETH parallel execution, RWA tokenization, gas optimization, CTF challenges.' },
    { type: 'text', text: '' },
    { type: 'label', text: '\u25C6 Track 3: MegaETH Deep Dive (ongoing)' },
    { type: 'text', text: '  New missions as MegaETH adds features, community challenges, mainnet-specific content.' },
    { type: 'text', text: '' },
