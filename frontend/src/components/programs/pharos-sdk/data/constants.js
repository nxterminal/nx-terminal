...
export const BOOT_MESSAGES = [
  { text: "PHAROS_SDK v1.0 \u2014 Developer Training Simulator", color: "#00bfff", delay: 0 },
  ...
  { text: "Connecting to Pharos...", color: "#00ff41", delay: 2000 },
...
export const MONAD_INFO = PHAROS_INFO;
