  ...
  missions: [
    ...
    // ═══════════════════════════════════════════
    {
      ...
      briefing:
        ...
        "Pharos Network is a Layer 1 blockchain capable of processing 30,000+ " +
      ...
      questions: [
        ...
        {
          question: "What makes Pharos Network different from Ethereum?",
          options: [
            "It doesn't use smart contracts",
            "It runs on a single server",
            "Parallel execution achieving 30K+ TPS with sub-second finality",
            "It only supports NFTs",
          ],
          correct: 2,
          explanation: "Pharos uses AsyncBFT consensus and parallel execution (SALI) to process transactions simultaneously, achieving 30,000+ TPS vs Ethereum's ~15 TPS.",
        },
        {
    ...
    // ═══════════════════════════════════════════
    {
      ...
      questions: [
        ...
        {
          question: "Pharos Atlantic Testnet Chain ID is:",
          options: [
            "1 (Ethereum Mainnet)",
            "688689",
            "56 (BNB Chain)",
          ...
          correct: 1,
          explanation: "Pharos Atlantic Testnet uses Chain ID 688689. You need this to add the network to MetaMask or other wallets.",
        },
      ],
      completionMessage:
    ...
    // ═══════════════════════════════════════════
    {
      ...
      briefing:
        ...
        "FaroSwap is the primary DEX on Pharos Network. It uses an Automated " +
      ...
      questions: [
        ...
        {
          question: "Why does Pharos' high TPS matter for DEX trading?",
          options: [
    ...
    // ═══════════════════════════════════════════
    {
      ...
      language: "javascript",
      codeLines: [
        { num: 1,  text: "// Query Pharos Atlantic Testnet via JSON-RPC", editable: false },
      ...
      completionMessage:
        ...
        "Finality: 0.47s | Chain: Pharos Atlantic\n\n" +
