  ...
  missions: [
    ...
    // ═══════════════════════════════════════════
    {
      ...
      briefing:
        ...
        "MegaETH is a Layer 1 blockchain capable of processing 30,000+ " +
      ...
      questions: [
        ...
        {
          question: "What makes MegaETH different from Ethereum?",
          options: [
          ...
          correct: 2,
          explanation: "MegaETH uses AsyncBFT consensus and parallel processing to process transactions simultaneously, achieving 30,000+ TPS vs Ethereum's ~15 TPS.",
        },
        {
          ...
          correct: 1,
          explanation: "Finality means a transaction is permanently confirmed and cannot be reversed. MegaETH achieves this in under 1 second.",
        },
      ],
      completionMessage:
    ...
    // ═══════════════════════════════════════════
    {
      ...
      briefing:
        ...
        "MegaETH, that identity is your wallet.\n\n" +
      ...
      questions: [
        ...
        },
        {
          ...
          correct: 1,
          explanation: "MegaETH Testnet uses Chain ID 4326. You need this to add the network to MetaMask or other wallets.",
        },
      ],
      completionMessage:
    ...
    // ═══════════════════════════════════════════
    {
      ...
      briefing:
        ...
        "Decentralized exchanges on MegaETH use an Automated " +
      ...
      questions: [
        ...
        {
          question: "Why does MegaETH's high TPS matter for DEX trading?",
          options: [
    ...
    // ═══════════════════════════════════════════
    {
      ...
      briefing:
        ...
        "needs to be decoded.\n\n" +
        "Your mission: complete the JavaScript code to query the MegaETH " +
      ...
      language: "javascript",
      codeLines: [
        { num: 1,  text: "// Query MegaETH via JSON-RPC", editable: false },
        { num: 2,  text: 'const RPC_URL = "https://carrot.megaeth.com/rpc";', editable: false },
        { num: 3,  text: "", editable: false },
