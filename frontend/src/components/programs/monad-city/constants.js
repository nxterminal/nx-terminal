...
export const SIGN_NAMES = [
  'ETH', 'DEFI', 'GMX', 'AAVE', 'UNI', 'LIDO', 'PYTH',
...
export const DISTRICT_BILLBOARDS = {
  ...
  yield:       ['aPRIORI', 'KINTSU', 'MAGMA', 'LIDO x ETH', 'YIELD MAX'],
  derivatives: ['dYdX', 'GMX PRO', 'SYNTHETIX', 'KWENTA', 'GAINS'],
  infra:       ['MEGAETH RPC', 'PYTH ORACLE', 'CHAINLINK', 'THE GRAPH', 'ALCHEMY'],
  ...
  parallel:    ['30K TPS', 'MEGA EVM', 'PARALLEL', 'ASYNCBFT', 'CONSENSUS'],
};
