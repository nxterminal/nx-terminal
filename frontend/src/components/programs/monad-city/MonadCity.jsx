        ...
        <div style={{
          ...
          <div className="win-raised" onClick={e => e.stopPropagation()} style={{
            ...
            <div style={{ padding: '20px 24px', textAlign: 'center', lineHeight: 1.8 }}>
              ...
              <div style={{ fontSize: '12px', color: '#a0a0a0', marginTop: 4 }}>10ms blocks | 100K TPS | Chain ID 4326</div>
              <div style={{ fontSize: '12px', color: '#a0a0a0', marginTop: 12 }}>Powered by NX Terminal</div>
