...
export const TOOLTIPS = {
  tps: 'Transactions Per Second — measures network throughput on MegaETH',
  block: 'Current block number on MegaETH (sub-second finality)',
  monPrice: 'Live ETH token price from CoinGecko',
  gas: 'Current gas price in Gwei — MegaETH keeps this extremely low',
  theStream: 'Real-time trade feed from all MegaETH DEXs',
  walletXray: 'Analyze any MegaETH wallet: balances, tokens, and activity',
  tokenRadar: 'Pool scoring engine — rates pools 0-100 for safety',
  clobVision: 'Live orderbook visualization for Kuru CLOB DEX',
  aiOracle: 'Ask questions about MegaETH DeFi using live market data',
...
export const API = {
  ...
  GOPLUS_TOKEN_SECURITY: (addr) => `https://api.gopluslabs.io/api/v1/token_security/4326?contract_addresses=${addr}`,
};
...
export const POLL_INTERVALS = {
  ...
  RPC: 400,               // MegaETH RPC poll interval (via useMonadRPC)
};
