...
const SECTIONS = [
  {
    ...
    content: 'MegaETH executes transactions in parallel while maintaining sequential consistency. Multiple transactions process simultaneously across different cores, then results are committed in the original block order. This gives 30,000+ TPS while preserving deterministic state transitions.',
  ...
  },
  {
    ...
    content: 'In MegaETH, consensus and execution happen concurrently. Nodes reach consensus on transaction ordering first, then execute in parallel. This decoupling means consensus never waits for execution to complete.',
  ...
  {
    title: 'MegaETHDb',
    content: 'MegaETHDb is a custom state database built from scratch for MegaETH. Unlike Ethereum\'s LevelDB/PebbleDB which wrap a generic key-value store around a Merkle Patricia Trie, MegaETHDb implements the trie natively on SSD with async I/O for maximum throughput.',
    ...
    diagram: (
      <div style={{ display: 'flex', gap: 24, padding: '16px 0' }}>
        ...
        <div style={{ flex: 1, padding: 12, border: '1px solid var(--mb-accent-primary)', borderRadius: 8, textAlign: 'center' }}>
          <div style={{ fontSize: 12, color: 'var(--mb-accent-primary)', marginBottom: 8 }}>MegaETH</div>
...
export default function MonadArchitecture() {
  ...
  return (
    <div>
      <h2 className="mb-h2 mb-mb-md">MegaETH Architecture</h2>
      <p className="mb-text-sm mb-mb-lg">
        MegaETH achieves 30,000+ TPS through four key innovations. Click each section to learn more.
      </p>
