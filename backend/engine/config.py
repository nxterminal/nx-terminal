...
# ECONOMY
# ============================================================
SALARY_PER_DAY = 200             # $NXT per dev per day
SALARY_INTERVAL_HOURS = 4        # Pay every 4 hours
SALARY_PER_INTERVAL = SALARY_PER_DAY // (24 // SALARY_INTERVAL_HOURS)

CLAIM_FEE_PERCENT = 10           # 10% fee on claims
